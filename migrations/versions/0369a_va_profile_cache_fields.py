...
def downgrade():
    ...
    # Delete data that will not fit into the downgraded schema
    op.execute("""
        DELETE FROM va_profile_local_cache WHERE va_profile_id > 2147483647 OR participant_id > 2147483647
    """)
