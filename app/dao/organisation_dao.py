...
from app.models import Organisation, Domain, InvitedOrganisationUser, Service
...
def dao_get_users_for_organisation(organisation_id):
    return (
        User.query.filter(User.organisations.any(id=organisation_id), User.state == 'active')
