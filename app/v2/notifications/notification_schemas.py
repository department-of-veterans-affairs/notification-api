...
get_notification_response = {
    ...
    'properties': {
        ...
        'callback_url': {'type': ['string', None], 'format': 'uri', 'pattern': '^https.*', 'maxLength': 255},
    },
    'required': [
...
post_sms_request = {
    ...
    'additionalProperties': False,
    'validationMessage': {'anyOf': 'Please provide either a phone number or recipient identifier.'},
}
...
post_email_request = {
    ...
    'additionalProperties': False,
    'validationMessage': {'anyOf': 'Please provide either an email address or a recipient identifier'},
}
...
post_letter_request = {
    ...
    'properties': {'reference': {'type': 'string'}, 'template_id': uuid, 'personalisation': letter_personalisation},
