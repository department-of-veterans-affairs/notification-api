...
class FeatureFlag(Enum):
    ...
    USE_PROFILE_API_V3 = 'USE_PROFILE_API_V3'
    COMBINE_CONTACT_INFO_AND_PERMISSIONS_LOOKUP = 'COMBINE_CONTACT_INFO_AND_PERMISSIONS_LOOKUP'
    IDENTIFY_MOBILE_TELEPHONE_NUMBERS = 'IDENTIFY_MOBILE_TELEPHONE_NUMBERS'
