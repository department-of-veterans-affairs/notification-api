...
def test_create_invited_org_user(
    ...
    json_resp = admin_request.post(
        'organisation_invite.invite_user_to_org', organisation_id=org.id, _data=data, _expected_status=201
    )
...
def test_create_invited_user_invalid_email(admin_request, sample_organisation, sample_user, mocker):
    ...
    json_resp = admin_request.post(
        'organisation_invite.invite_user_to_org', organisation_id=org.id, _data=data, _expected_status=400
    )
