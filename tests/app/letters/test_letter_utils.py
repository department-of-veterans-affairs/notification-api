...
def test_get_bucket_name_and_prefix_for_notification_get_from_sent_at_date(
    ...
    assert (
        bucket_prefix
        == '{folder}/NOTIFY.{reference}'.format(folder='2019-08-02', reference=notification.reference).upper()
    )
...
def test_get_bucket_name_and_prefix_for_notification_from_created_at_date(
    ...
    assert (
        bucket_prefix
        == '{folder}/NOTIFY.{reference}'.format(folder='2019-08-03', reference=notification.reference).upper()
    )
...
def test_get_letter_pdf_gets_pdf_from_correct_bucket(
    sample_precompiled_letter_notification_using_test_key, bucket_config_name, filename_format, aws_credentials
):
