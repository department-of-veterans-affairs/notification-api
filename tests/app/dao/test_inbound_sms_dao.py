...
def test_get_all_inbound_sms(sample_service):
    ...
    inbound = create_inbound_sms(service)
...
def test_get_all_inbound_sms_limits_and_orders(sample_service):
    ...
    with freeze_time('2017-01-01'):
        create_inbound_sms(service)
    with freeze_time('2017-01-03'):
        three = create_inbound_sms(service)
    with freeze_time('2017-01-02'):
        two = create_inbound_sms(service)
...
def test_get_all_inbound_sms_filters_on_time(sample_service, notify_db_session):
    service = sample_service()
    create_inbound_sms(service, created_at=datetime(2017, 8, 7, 3, 59))  # sunday evening
    sms_two = create_inbound_sms(service, created_at=datetime(2017, 8, 7, 4, 0))  # monday (7th) morning
...
def test_count_inbound_sms_for_service_filters_messages_older_than_n_days(sample_service):
    ...
    create_inbound_sms(service, created_at=datetime(2019, 6, 3, 3, 59))
    create_inbound_sms(service, created_at=datetime(2019, 6, 3, 3, 59))
    create_inbound_sms(service, created_at=datetime(2019, 6, 3, 4, 1))
...
def test_get_inbound_sms_by_id_returns(sample_service):
    service = sample_service()
    inbound_sms = create_inbound_sms(service=service)
...
def test_most_recent_inbound_sms_only_returns_most_recent_for_each_number(notify_api, sample_service):
    service = sample_service()
    create_inbound_sms(service, user_number='447700900111', content='111 1', created_at=datetime(2017, 1, 1))
    create_inbound_sms(service, user_number='447700900111', content='111 2', created_at=datetime(2017, 1, 2))
    create_inbound_sms(service, user_number='447700900111', content='111 3', created_at=datetime(2017, 1, 3))
    create_inbound_sms(service, user_number='447700900111', content='111 4', created_at=datetime(2017, 1, 4))
    create_inbound_sms(service, user_number='447700900111', content='111 5', created_at=datetime(2017, 1, 5))
    create_inbound_sms(service, user_number='447700900222', content='222 1', created_at=datetime(2017, 1, 1))
    create_inbound_sms(service, user_number='447700900222', content='222 2', created_at=datetime(2017, 1, 2))
...
def test_most_recent_inbound_sms_paginates_properly(notify_api, sample_service):
    ...
    create_inbound_sms(service, user_number='447700900111', content='111 1', created_at=datetime(2017, 1, 1))
    create_inbound_sms(service, user_number='447700900111', content='111 2', created_at=datetime(2017, 1, 2))
    create_inbound_sms(service, user_number='447700900222', content='222 1', created_at=datetime(2017, 1, 3))
    create_inbound_sms(service, user_number='447700900222', content='222 2', created_at=datetime(2017, 1, 4))
    create_inbound_sms(service, user_number='447700900333', content='333 1', created_at=datetime(2017, 1, 5))
    create_inbound_sms(service, user_number='447700900333', content='333 2', created_at=datetime(2017, 1, 6))
    create_inbound_sms(service, user_number='447700900444', content='444 1', created_at=datetime(2017, 1, 7))
    create_inbound_sms(service, user_number='447700900444', content='444 2', created_at=datetime(2017, 1, 8))
...
def test_most_recent_inbound_sms_only_returns_values_within_7_days(sample_service):
    service = sample_service()
    # just out of bounds
    create_inbound_sms(service, user_number='1', content='old', created_at=datetime(2017, 4, 3, 3, 59, 59))
    # just in bounds
    create_inbound_sms(service, user_number='2', content='new', created_at=datetime(2017, 4, 3, 4, 0, 0))
