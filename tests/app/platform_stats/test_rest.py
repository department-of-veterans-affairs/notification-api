...
def test_get_platform_stats_response_when_toggle_is_on(
    ...
    sample_ft_notification_status(
        utc_date=date(2022, 1, 1), template=email_template, notification_status=NOTIFICATION_DELIVERED, count=1
    )

    sample_ft_notification_status(
        utc_date=date(2021, 12, 1), template=email_template, notification_status=NOTIFICATION_DELIVERED, count=29
    )

    sample_ft_notification_status(
        utc_date=date(2022, 1, 1), template=sms_template, notification_status=NOTIFICATION_DELIVERED, count=14
    )
