...
def test_event_message_invalid_message(mocker, db_session, sample_delivery_status_result_message,
...
def test_attempt_get_notification_triggers_should_retry(mocker, db_session, sample_delivery_status_result_message,
                                                        sample_translate_return_value, sample_notification):
    """
...
def test_missing_body_triggers_retry(db_session, sample_delivery_status_result_message,
                                     sample_translate_return_value, sample_notification):
...
def test_none_notification_platform_status_triggers_retry(mocker, db_session, sample_delivery_status_result_message,
                                                          sample_translate_return_value, sample_notification):
...
def test_invalid_body_triggers_retry(db_session, sample_delivery_status_result_message,
                                     sample_translate_return_value, sample_notification):
    """
...
def test_should_exit(mocker, db_session, sample_delivery_status_result_message, sample_notification):
    ...
    assert not process_delivery_status_result_tasks.process_delivery_status(event=sample_delivery_status_result_message)
