...
def test_get_communication_item(admin_request, sample_communication_item):
    response = admin_request.get(
        'communication_item.get_communication_item', 200, communication_item_id=sample_communication_item.id
    )
...
def test_delete_communication_item(notify_db_session, admin_request, sample_communication_item):
    ...
    admin_request.delete(
        'communication_item.delete_communication_item', 202, communication_item_id=sample_communication_item.id
    )
