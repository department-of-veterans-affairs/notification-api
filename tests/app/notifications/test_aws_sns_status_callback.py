...
def mock_dao_get_notification_by_reference(mocker):
    return mocker.patch(
        'app.notifications.aws_sns_status_callback.dao_get_notification_by_reference'
    )
...
def mock_update_notification_status(mocker):
    return mocker.patch(
        'app.notifications.aws_sns_status_callback._update_notification_status'
    )
...
def mock_process_service_callback(mocker):
    return mocker.patch(
        'app.notifications.aws_sns_status_callback.process_service_callback'
    )
...
def mock_send_callback_metrics(mocker):
    return mocker.patch(
        'app.notifications.aws_sns_status_callback.send_callback_metrics'
    )
