...
class TestSendCallbackMetrics:
    ...
    def test_should_increase_counter_for_status(self, notify_api, mock_notification, mocks_statsd, status):
    ...
    def test_should_report_timing_only_when_notification_sent_at(
        self, notify_api, mock_notification, mocks_statsd, sent_at, should_call
    ):
