...
def test_update_service_with_valid_provider(admin_request, notify_db_session, sample_provider, sample_service):
    data = {
...
@pytest.mark.parametrize('name, email_from', [('UNIQUE', 'unique'), ('Unique.', 'unique'), ('**uniQUE**', 'unique')])
